...
society_members: '250'
attendees: '200'
venues: 'Around Europe (Brussels (BE), Marseille (FR) Zurich (CH), Perugia (IT), Munster (DE), Paris (FR), Cambridge (UK), Strasbourg (FR), Leuven (BE), Warsaw (PO), Toulouse (FR), Aix-en-Provence (FR), Valladolid (ES), Hamburg (DE)'
frequency: 'Biennial'
sponsors: ''
virtual: 'None'
...
ecr_promotion: 'Yes, it was launched the junior board of the society (only for ECRs)'
